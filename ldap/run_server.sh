...
export DIR_ADMIN_PASSWORD=${DIR_ADMIN_PASSWORD:-${DIR_MANAGER_PASSWORD:-"admin"}}
export DIR_ADMIN_USERNAME=${DIR_ADMIN_USERNAME:-"admin"}
export DIR_ADMIN_UID=${DIR_ADMIN_UID:-"15000"}
export DIR_MANAGER_PASSWORD=${DIR_MANAGER_PASSWORD:-${DIR_ADMIN_PASSWORD:-"admin"}}
export DIR_SUFFIX=${DIR_SUFFIX:-"dc=idptestbed"}
